...
ServerEvents.recipes(event => {
  ...
  let del_recipe_tree = (element, rohmaterial) => {
    event.remove({output: "#forge:" + rohmaterial + "/" + element, mod: 'mekanism'})
    event.remove({output: "#forge:" + rohmaterial + "/" + element, mod: 'thermal'})
    event.remove({output: "#forge:" + rohmaterial + "/" + element, mod: 'immersiveengineering'})
    //event.remove({output: "#forge:" + rohmaterial + "/" + element, mod: 'alltheores'})
  }
